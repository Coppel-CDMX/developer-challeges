...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    this.fetchVehiclesHistory(_objectSpread(_objectSpread({}, this.filters), {}, {
      page: 1
    }));
  },
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_2__.mapState)({
    ...
    newHistorySaved: function newHistorySaved(state) {
      return state.vehiclesHistory.saved;
    },
    vehiclesStatuses: function vehiclesStatuses(state) {
      return state.vehiclesStatus.items;
    },
    vehiclesHistory: function vehiclesHistory(state) {
      return state.vehiclesHistory.items;
    },
    vehiclesStatusReasons: function vehiclesStatusReasons(state) {
      return state.vehiclesStatusReason.items;
    },
    errors: function errors(state) {
      return state.vehiclesHistory.errors;
    },
    copyLastHistory: function copyLastHistory(state) {
      return state.vehiclesHistory.copyLastHistory;
    }
  })), {}, {
    vehiclesHistoryData: function vehiclesHistoryData() {
  ...
  methods: _objectSpread(_objectSpread({}, (0,vue_wait__WEBPACK_IMPORTED_MODULE_0__.mapWaitingActions)({
    ...
    addRegister: function addRegister() {
      var newRegister = _objectSpread(_objectSpread({}, this.historySelected), {}, {
        status: this.status,
    ...
    updateRegister: function updateRegister() {
      var updatedRegister = _objectSpread(_objectSpread({}, this.historySelected), {}, {
        status: this.status,
        statusReason: this.statusReason
      });
      this.updateExistRegister(updatedRegister);
    },
    vehicleAge: function vehicleAge(vehicleDate) {
      var dateNow = this.$moment();
      return dateNow.diff(vehicleDate, 'years');
    },
    openModal: function openModal(history) {
  ...
  watch: {
    newHistorySaved: function newHistorySaved(newValue) {
      var _this2 = this;
      if (newValue) {
    ...
    copyLastHistory: function copyLastHistory(newValue) {
      var _this3 = this;
      if (newValue) {
        this.search();
        this.showSuccessMessage = true;
    ...
    status: function status(newValue) {
      if (newValue) {
        this.fetchVehiclesStatusReasons({
          vehiclesStatusId: newValue.id
        });
      }
    }
  }
        ...
        _c("div", { staticClass: "row g-3 align-items-end" }, [
          _c("div", { staticClass: "col-auto text-center" }, [
            _c(
              ...
              [_vm._v("Palabra clave (ID SAP o VIN)")]
            ),
            _vm._v(" "),
            _c("input", {
              directives: [
          ...
          _c("div", { staticClass: "col-auto" }, [
            ...
            _vm._v(" "),
            _vm.user.rolename != "Administrador" && _vm.can("history.can.copy")
              ? _c(
                  "button",
                  {
                    staticClass: "btn btn-primary mt-2",
        ...
        : _c(
            ...
            [
              _c("p", [
                _vm._v(
                  "Total de registros: " +
                    _vm._s(_vm._f("formatNumber")(_vm.vehiclesHistory.total))
                ),
              ]),
              _vm._v(" "),
              _c(
                "Table",
                {
                  attrs: { params: _vm.vehiclesHistory },
                ...
                [
                  _vm._v(" "),
                  _vm._l(_vm.vehiclesHistoryData, function (history) {
                    return _c("tr", { key: history.id }, [
                      _c("td", { staticClass: "text-center" }, [
                        ...
                        _vm
                          .$moment()
                          .diff(_vm.$moment(history.created_at), "days") == 0
                          ? _c(
                              "button",
                              {
                                staticClass: "btn btn-primary mt-2",
                      ...
                      _c(
                        ...
                        {
                          class:
                            history.status.symbol === "disponible"
                              ? "bg-success"
                              : "bg-warning",
                        },
                      ...
                      _c("td", { staticClass: "bg-primary" }, [
                        _vm._v(
                          _vm._s(
                            history.status_reason
                              ? history.status_reason.name
                              : ""
                          )
                        ),
                      ]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(history.vehicle.id_sap))]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(history.vehicle.vin))]),
                      _vm._v(" "),
                      _c("td", [
                        _vm._v(_vm._s(history.vehicle.agency.uen.drv.name)),
                      ]),
                      _vm._v(" "),
                      _c("td", [
                        _vm._v(_vm._s(history.vehicle.agency.uen.name)),
                      ]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(history.vehicle.agency.code))]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(history.vehicle.agency.name))]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(history.use.name))]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(history.owner.name))]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(history.brand.name))]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(history.vehicle.year))]),
                      _vm._v(" "),
                      _c("td", [
                        _vm._v(_vm._s(history.vehicle.number_of_curtains)),
                      ]),
                      _vm._v(" "),
                      _c("td", [
                        _vm._v(
                          _vm._s(
                            _vm.$moment(history.created_at).format("DD/MM/YYYY")
                          )
                        ),
                      ]),
                      _vm._v(" "),
                      _c("td", [
                        _vm._v(
                          _vm._s(_vm.$moment(history.created_at).format("MMMM"))
                        ),
                      ]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(history.type.name))]),
                      _vm._v(" "),
                      _c("td", [
                        _vm._v(_vm._s(_vm.vehicleAge(history.vehicle.year))),
                      ]),
                    ])
                  }),
                ],
            ...
            _c("div", { staticClass: "modal-body" }, [
              _c("div", { staticClass: "row" }, [
                _c("div", { staticClass: "col text-center" }, [
                  _c("label", [_vm._v("ID SAP")]),
                  _vm._v(" "),
                  _c("input", {
                    staticClass: "form-control text-muted",
                    attrs: { type: "text", readonly: "" },
                    domProps: {
                      value: _vm.historySelected
                        ? _vm.historySelected.vehicle.id_sap
                        : "-",
                    },
                  }),
                ]),
                ...
                _c("div", { staticClass: "col text-center" }, [
                  ...
                  _c("input", {
                    ...
                    domProps: {
                      value: _vm.historySelected
                        ? _vm.historySelected.vehicle.vin
                        : "-",
                    },
                  }),
                ]),
                ...
                _c("div", { staticClass: "col text-center" }, [
                  ...
                  _c("input", {
                    ...
                    domProps: {
                      value: _vm.historySelected
                        ? _vm.historySelected.vehicle.agency.code
                        : "-",
                    },
                  }),
                ]),
                ...
                _c("div", { staticClass: "col" }, [
                  ...
                  _c(
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _vm._l(_vm.vehiclesStatuses, function (vehicleStatus) {
                        return _c(
                          "option",
                          {
                            key: vehicleStatus.id,
                            domProps: { value: vehicleStatus },
                          },
                          [
                            _vm._v(
                              "\n                                    " +
                                _vm._s(vehicleStatus.name) +
                                "\n                                "
                            ),
                          ]
                        )
              ...
              _c("div", { staticClass: "row mt-3" }, [
                _c("div", { staticClass: "col" }, [
                  _c("label", [_vm._v("Motivo del estatus")]),
                  _vm._v(" "),
                  _c(
                    "select",
                    {
                      ...
                      attrs: {
                        disabled:
                          !_vm.status || _vm.status.symbol == "disponible",
                      },
                      on: {
                        change: function ($event) {
                          var $$selectedVal = Array.prototype.filter
                          ...
                          _vm.statusReason = $event.target.multiple
                            ? $$selectedVal
                            : $$selectedVal[0]
                        },
                      },
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _vm._l(
                        _vm.vehiclesStatusReasons,
                        function (vehiclesStatusReason) {
                          return _c(
                            "option",
                            {
                              key: vehiclesStatusReason.id,
                              domProps: { value: vehiclesStatusReason },
                            },
                            [
                              _vm._v(
                                "\n                                    " +
                                  _vm._s(vehiclesStatusReason.name) +
                                  "\n                                "
                              ),
                            ]
                          )
                    ...
                    "button",
                    {
                      ...
                      on: {
                        click: function ($event) {
                          $event.stopPropagation()
                          $event.preventDefault()
                          return _vm.addRegister.apply(null, arguments)
                        },
                      },
                    },
                    [_vm._v("Guardar")]
                    ...
                    "button",
                    {
                      ...
                      on: {
                        click: function ($event) {
                          $event.stopPropagation()
                          $event.preventDefault()
                          return _vm.updateRegister.apply(null, arguments)
                        },
                      },
                    },
                    [_vm._v("Actualizar")]
